#!/usr/bin/env python3
"""LEGACY v1.0.0 figure generator — NOT VALID FOR v1.1.0 CLAIMS.

This script depends on outcome-derived discrimination screening and historical
CSV layouts. It is retained only for provenance. The authoritative v1.1.0
figures are generated by analysis/r7_make_figures.py from R6 outputs.
"""
